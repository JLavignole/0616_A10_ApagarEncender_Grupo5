...
@section('contenido')
    ...
    {{-- ── Filtros ── --}}
    <form method="GET" action="{{ route('gestor.incidencias') }}" class="filtros-bar" id="formFiltros">
        ...
        @if(request()->hasAny(['buscar', 'estado', 'prioridad', 'orden']))
            <a href="{{ route('gestor.incidencias') }}" class="btn-limpiar" title="Limpiar filtros">
